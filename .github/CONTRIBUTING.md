...
Use benchmark testing as needed. The benchmark and experiment code lives in
[`lab/`](https://github.com/TomTonic/Set3/blob/main/lab/README.md) behind the
`set3lab` build tag, together with the commands to reproduce each measurement.
