...
// Runtime comparison of WH32 against splitmix64 on 32-bit inputs. This test
// used to sit in this file commented out, which meant no compiler or linter
// ever looked at it; it is live again now that the set3lab build tag keeps it
// out of the everyday build.
package hashperf
...
func Test32BitHasherPerformanceComparison(t *testing.T) {
	...
	for range repeats {
		...
		for i := range innerLoops {
			x ^= hashalt.WH32(i, 0xC0FFEE1234567890)
		}
