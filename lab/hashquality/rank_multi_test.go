...
func canonicalF32Values() <-chan uint64 {
	...
	go func() {
		...
		x := hashbench.XorShift32Star{State: rtcompare.NewCPRNG(16).Uint32() | 1}
...
func candidateSetF32() []rankCandidateM {
	return []rankCandidateM{
		...
		// ── wh32detExtMul variants ───────────────────────────────────────────
		{
			...
			isProd: true,
			hash: func(raw, seed uint64) uint64 {
				return hashalt.WH32DetExtMul(hashing.GoldenRatio32*raw, seed)
			},
		},
		{
			label: "wh32detExtMul + sqrt2_1_32",
			hash: func(raw, seed uint64) uint64 {
				return hashalt.WH32DetExtMul(hashing.Sqrt2_1_32*raw, seed)
			},
		},
		{
			label: "wh32detExtMul + pie7_32",
			hash: func(raw, seed uint64) uint64 {
				return hashalt.WH32DetExtMul(hashing.Pie7_32*raw, seed)
			},
		},
		{
			label: "wh32detExtMul + replication_0x0000000100000001",
			hash: func(raw, seed uint64) uint64 {
				return hashalt.WH32DetExtMul(uint64(0x0000_0001_0000_0001)*raw, seed)
			},
		},
		{
			label: "wh32detExtMul + largestPrime32",
			hash: func(raw, seed uint64) uint64 {
				return hashalt.WH32DetExtMul(uint64(0x0000_0000_FFFF_FFFB)*raw, seed)
			},
		},
	}
}
...
func candidateSetI16() []rankCandidateM {
	return []rankCandidateM{
		...
		// ── wh16detExtMul variants ───────────────────────────────────────────
		{
			...
			hash: func(raw, seed uint64) uint64 {
				return hashalt.WH16DetExtMul(uint64(0x0001_0001_0001_0001)*raw, seed)
			},
		},
		{
			label: "wh16detExtMul + pie7_48",
			hash: func(raw, seed uint64) uint64 {
				return hashalt.WH16DetExtMul(hashing.Pie7_48*raw, seed)
			},
		},
		{
			label: "wh16detExtMul + goldenRatio48",
			hash: func(raw, seed uint64) uint64 {
				return hashalt.WH16DetExtMul(hashing.GoldenRatio48*raw, seed)
			},
		},
		{
			label: "wh16detExtMul + sqrt2_1_48",
			hash: func(raw, seed uint64) uint64 {
				return hashalt.WH16DetExtMul(hashing.Sqrt2_1_48*raw, seed)
			},
		},
	}
}
